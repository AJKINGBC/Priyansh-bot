...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "Kya kar rahe ho") || (event.body.toLowerCase() == "kkrh")) {
  ...
  if ((event.body.toLowerCase() == "Shut up") || (event.body.toLowerCase() == "shut up") || (event.body.toLowerCase() == "shut") || (event.body.toLowerCase() == "stup")) {
  ...
  if (event.body.indexOf("Janu") == 0 || (event.body.indexOf("Jaan") == 0)) {
    var msg = {
      body: ` 🌸====『 ${name} 』====🌸 \n\n ${rand} \n\n                       `
    }
